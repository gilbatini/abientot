    ...
    <html lang="en">
      <body>
        ...
        <div className="fixed bottom-6 right-6 z-[9999] flex items-center gap-3 group">
          {/* Tooltip */}
          <span className="opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-200 bg-[#111] text-white font-body text-[12px] px-3 py-1.5 rounded-lg shadow-lg whitespace-nowrap pointer-events-none select-none">
            Chat with us
          </span>
          {/* Button */}
          <a
            ...
            className="relative w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#1ebe5c] flex items-center justify-center shadow-xl shadow-[#25D366]/40 hover:shadow-[#25D366]/60 hover:-translate-y-0.5 transition-all duration-300"
          >
            {/* Pulse ring */}
            <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-30" />
            {/* WhatsApp icon */}
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 text-white relative z-10" xmlns="http://www.w3.org/2000/svg">
